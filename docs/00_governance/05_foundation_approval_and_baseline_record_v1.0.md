...
| Metadata blocks added and set to `APPROVED` | **PASSED** | Metadata headers updated across active specs. |
| Reorganization links repaired | **PASSED** | Sibling relative markdown links verified and validated. |
...
|---|---|---|---|
| **GOV-001** | [Decision and Open-Question Register v1.0](01_decision_and_open_question_register_v1.0.md) | v1.0 | APPROVED |
| **GOV-002** | [Cross-Document Consistency Review v1.0](02_cross_document_consistency_review_v1.0.md) | v1.0 | APPROVED |
| **GOV-003** | [Consolidated System Specification v1.0](03_consolidated_system_specification_v1.0.md) | v1.0 | APPROVED |
| **GOV-004** | [Planning Status and Roadmap v1.1](04_planning_status_and_roadmap_v1.1.md) | v1.1 | APPROVED |
| **SCP-001** | [Project Constraints v1.0](../01_scope_and_requirements/01_project_constraints_v1.0.md) | v1.0 | APPROVED |
| **SCP-002** | [System Scope v1.0](../01_scope_and_requirements/02_system_scope_v1.0.md) | v1.0 | APPROVED |
| **SCP-003** | [Actors and Operational Scope v1.1](../01_scope_and_requirements/03_actors_and_operational_scope_v1.1.md) | v1.1 | APPROVED |
| **REQ-001** | [Functional Requirements and Traceability v1.1](../01_scope_and_requirements/04_functional_requirements_and_traceability_v1.1.md) | v1.1 | APPROVED |
| **REQ-002** | [Non-Functional Requirements v1.0](../01_scope_and_requirements/05_non_functional_requirements_v1.0.md) | v1.0 | APPROVED |
| **DOM-001** | [Domain Glossary v1.0](../03_domain/01_domain_glossary_v1.0.md) | v1.0 | APPROVED |
| **DOM-002** | [Lifecycle and Invariant Catalogue v1.0](../03_domain/02_lifecycle_and_invariant_catalogue_v1.0.md) | v1.0 | APPROVED |
| **DOM-003** | [Station, EVSE, Connector, Tariff and Booking Policy Model v1.0](../03_domain/03_station_evse_connector_tariff_policy_model_v1.0.md) | v1.0 | APPROVED |
| **DOM-004** | [Booking Lifecycle and Policy Specification v1.0](../03_domain/04_booking_lifecycle_and_policy_v1.0.md) | v1.0 | APPROVED |
| **DOM-005** | [Availability Calculation Model v1.0](../03_domain/05_availability_calculation_model_v1.0.md) | v1.0 | APPROVED |
| **DOM-006** | [Maintenance, Fault and Reassignment Workflows v1.0](../03_domain/06_maintenance_fault_reassignment_workflows_v1.0.md) | v1.0 | APPROVED |
| **PLT-001** | [Background Processes and Distributed Consistency v1.0](../04_platform_and_integrations/01_background_processes_distributed_consistency_v1.0.md) | v1.0 | APPROVED |
| **SIM-001** | [Charger Simulator Protocol v1.0](../04_platform_and_integrations/02_charger_simulator_protocol_v1.0.md) | v1.0 | APPROVED |
| **NOT-001** | [Notification Rules and Essential Email Matrix v1.0](../04_platform_and_integrations/03_notification_rules_email_matrix_v1.0.md) | v1.0 | APPROVED |
| **PRV-001** | [Privacy, Retention, Export, Deletion and Anonymization v1.0](../06_security_and_privacy/01_privacy_retention_export_deletion_v1.0.md) | v1.0 | APPROVED |
...
3. **Database:** PostgreSQL for primary storage. Redis only where measured need justifies it.

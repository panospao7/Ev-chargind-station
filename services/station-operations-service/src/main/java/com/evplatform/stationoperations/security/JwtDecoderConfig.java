...
/**
 * JWT decoder for the internal booking-operations API (I1-IAM-002,
 * SEC-001 §8.3). Same validation chain as the Discovery service decoder:
 *
 * <ul>
 ...
 *       allowlist is {ev-bff (after token exchange), svc-station-operations

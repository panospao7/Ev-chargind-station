 ...
 * same @Value binding rule the {@code discovery.consumer.*} properties
 * follow, MSG-002 m4 lesson).
 *
 * <ul>
 ...
 *   <li>{@code requiredScope} — the scope the internal discovery API
 *       demands (SEC-001 §8.4 analog, recorded I1-IAM-002 decision).</li>
 * </ul>
 */
@Component
